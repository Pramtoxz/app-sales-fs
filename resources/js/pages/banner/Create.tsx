        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-lg font-semibold">Tambah Banner</h1>
                        <p className="text-muted-foreground text-sm">Upload gambar banner untuk ditampilkan di aplikasi mobile</p>
                    </div>
                </div>
