    ...
    */
    ...
    'connections' => [
        ...
        'pgsql' => [
            ...
            'prefix' => '',
            'prefix_indexes' => true,
            'search_path' => env('DB_PGSQL_SCHEMA', 'salestools'),
            'sslmode' => 'prefer',
        ],

        'pgsql_sales' => [
            'driver' => 'pgsql',
            'url' => env('DB_URL_SALES'),
            'host' => env('DB_HOST_SALES', '202.78.200.29'),
            'port' => env('DB_PORT_SALES', '51098'),
            'database' => env('DB_DATABASE_SALES', 'dms_clone'),
            'username' => env('DB_USERNAME_SALES', 'postgres'),
            'password' => env('DB_PASSWORD_SALES', ''),
            'charset' => 'utf8',
            'prefix' => '',
            'prefix_indexes' => true,
            'search_path' => 'public,H1_DOS,H1_HC3,HC3,Master_Schema',
            'sslmode' => 'prefer',
        ],
